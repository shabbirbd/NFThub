...
const Newsletter = () => {
    return (
        <div className='container mx-auto  mt-10 py-24 mb-14'>
            <div className='mb-11 lg:w-8/12 mx-auto text-center'>
                <h2 className="text-2xl sm:text-3xl xl:text-5xl font-bold mb-2 dark:text-white">Subscribe to the <span className="text-violet-600">Newsletter</span></h2>
                <p className="font-normal px-5 text-base text-slate-400">Receive our latest thinking, insights, and
                     provocations
            ...
            <div className="sm:flex justify-between items-center sm:border-2 rounded-md lg:w-6/12 md:w-8/12 mx-auto border-violet-600 border-3">
